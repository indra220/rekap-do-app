...
export default function Home() {
  ...
  if (view === "update") {
    return <UpdateView onBack={() => setView("dashboard")} />;
  }
      ...
      <div className="max-w-[1600px] mx-auto space-y-6">
        ...
        <div className="bg-white p-6 rounded-3xl shadow-sm border border-slate-200 flex justify-between items-center relative">
          ...
          <div className="flex items-center gap-4">
            <button onClick={() => setView("update")} className="bg-white border border-slate-200 text-slate-500 px-6 py-2.5 rounded-2xl font-black text-sm hover:bg-slate-50 transition flex items-center gap-2">Update v{APP_VERSION}</button>
